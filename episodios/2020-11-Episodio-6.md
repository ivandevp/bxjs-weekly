...
audio: "
<iframe src='https://anchor.fm/unexpected-news/embed/episodes/Episodio-6---2020-Semana-11-ebljoh' height='102px' width='400px' frameborder='0' scrolling='no'></iframe>"
---

# Episodio 6 - Semana 11, 2020

## Guías de inicio

- [Introduction to D3](https://observablehq.com/@mitvis/introduction-to-d3)
- [React Hooks with Fiebase Firestore](https://blog.logrocket.com/react-hooks-with-firebase-firestore/)
...
- [Speed up the navigation speed in your app using ngx-quicklink](https://twitter.com/mgechev/status/1238367954380693504?s=20)
...
- [Writing a Vue component using TDD: a gentle introduction](https://dev.to/astagi/writing-a-vue-component-using-tdd-a-gentle-introduction-4n2d)
...
- [Easiest way to do a dark theme with CSS vars (and JS!)](https://dev.to/corentints/easiest-way-to-do-a-dark-theme-with-css-vars-and-js-26ah)
- [Node v14.0.0 - Draft roadmap](https://github.com/nodejs/node/pull/32181)

## Releases

- [Rollup v2.0.0](https://github.com/rollup/rollup/releases/tag/v2.0.0)
- [Immer v6.0.0](https://github.com/immerjs/immer/releases/tag/v6.0.0)
- [Next.js 9.3](https://nextjs.org/blog/next-9-3)
- [VS Code v1.43](https://code.visualstudio.com/updates/v1_43)
- [Firefox 74.0](https://www.mozilla.org/en-US/firefox/74.0/releasenotes/)
- [Node v13.11.0](https://nodejs.org/en/blog/release/v13.11.0/)
- [Reach UI](https://github.com/reach/reach-ui/releases/tag/v0.9.0)
- [Mint 0.8.0](https://www.mint-lang.com/blog/mint-0.8.0)
- [testing-library](https://twitter.com/kentcdodds/status/1238247725629616131?s=20)

## Libs

- [speed-measure-webpack-plugin](https://github.com/stephencookdev/speed-measure-webpack-plugin)
- [scriptlint](https://github.com/peerigon/scriptlint)
- [react-loaderrs-kit](https://github.com/Seimodei/react-loaders-kit)
...
- [DuckDuckGo vertical media queries](https://twitter.com/simevidas/status/1238576658761867264)
- [Wake Lock API](https://twitter.com/tomayac/status/1238188319189671954?s=20)
