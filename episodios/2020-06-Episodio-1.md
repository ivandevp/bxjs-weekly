...
audio: "
<iframe src='https://anchor.fm/unexpected-news/embed/episodes/Episodio-1---2020-Semana-6-eap12l' height='102px' width='400px' frameborder='0' scrolling='no'></iframe>
"
---
...
- [Why we still need to use state management libraries in React?](https://medium.com/javascript-in-plain-english/why-we-still-need-to-use-state-management-libraries-in-reactjs-1e53bd18dab5)
...
- [Introducing Firefox and Edge Support in Cypress 4.0](https://dev.to/cypress/introducing-firefox-and-edge-support-in-cypress-4-0-4nda)
...
- [Tip: With Chrome DevTools open, click/hold the Reload button for bonus Empty Cache & Hard Reload options](https://twitter.com/addyosmani/status/1221379754823012352?s=12)
- [Changes to npm Unpublish Policy - January 2020](https://blog.npmjs.org/post/190553543620/changes-to-npm-unpublish-policy-january-2020)
- [Gradually using TypeScript in Your React Project](https://blog.bitsrc.io/react-js-to-typescript-how-to-migrate-gradually-d82026126d29)
- [How to write GraphQL middleware (Node, Apollo Server, Express)](https://dev.to/seancwalsh/how-to-write-graphql-middleware-node-apollo-server-express-2h87)
...
- [Input File Behavior in Browsers](https://twitter.com/sindresorhus/status/1225802275068637184?s=20)
- [Pair programming session for adding TS support to import type in BabelJS](https://twitter.com/left_pad/status/1225797738094301189?s=20)
- [Why Web Browsers are free](https://www.youtube.com/watch?v=iv-i0qBhETM&feature=youtu.be)
